...
[[ ! "$MANGO_SIMULATION_REPO" ]]&&  echo no MANGO_SIMULATION_REPO=$MANGO_SIMULATION_REPO&& exit 1
[[ ! "$MANGO_SIMULATION_BRANCH" ]]&&  echo no MANGO_SIMULATION_BRANCH=$MANGO_SIMULATION_BRANCH&& exit 1
...
echo MANGO_SIMULATION_REPO: $MANGO_SIMULATION_REPO >> env.output
echo MANGO_SIMULATION_BRANCH: $MANGO_SIMULATION_BRANCH >> env.output
